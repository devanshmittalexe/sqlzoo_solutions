...
select distinct a.company,(a.num) from route a join route b on (a.company = b.company and a.num=b.num) and a.stop=115 and b.stop=137
...
select s2.name, r1.company, r1.num from route r1 join route r2 on (r1.num=r2.num and r1.company=r2.company) 
...
JOIN stops s1       ON r1.stop = s1.id
JOIN stops transfer ON r2.stop = transfer.id
JOIN stops s4       ON r4.stop = s4.id
WHERE s1.name = 'Craiglockhart'
AND s4.name = 'Lochend'
AND (r1.num != r3.num OR r1.company != r3.company)
ORDER BY r1.num, r1.company, transfer.name, r3.num, r3.company;